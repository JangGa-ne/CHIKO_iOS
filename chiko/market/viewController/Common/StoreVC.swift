...
class StoreVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /// check
        ([checkBusinessRegNum_img, checkStoreNameChi_img, checkStoreNameEng_img, checkStoreTel_img, checkStoreAddressStreet_img, checkStoreAddressDetail_img, checkStoreAddressZipCode_img, checkStoreMainPhoto_img, checkpassbook_img, checkBusinessReg_img, checkBuildingContract_img] as [UIImageView]).enumerated().forEach { i, img in
            img.isHidden = true
        }
        /// notice
    ...
    @objc func changedEditStoreInfo_if(_ sender: UITextField) {
        ...
        let check: UIImageView = [checkBusinessRegNum_img, checkStoreNameChi_img, checkStoreNameEng_img, checkStoreTel_img, checkStoreAddressStreet_img, checkStoreAddressDetail_img, checkStoreAddressZipCode_img, checkStoreMainPhoto_img, checkpassbook_img, checkBusinessReg_img, checkBuildingContract_img][sender.tag]
