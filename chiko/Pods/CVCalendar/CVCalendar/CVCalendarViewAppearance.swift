...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0xFFAC0F)
    public var dayLabelWeekdaySelectedBackgroundAlpha: CGFloat? = 0.8
    public var dayLabelPresentWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0x61C0A7)
