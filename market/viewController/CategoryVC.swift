...
//    var WhGoodsVCdelegate: WhGoodsVC? = nil
    
    var WhGoodsUploadVCdelegate: WhGoodsUploadVC? = nil
    var WhGoodsUploadTCdelegate: WhGoodsUploadTC? = nil
...
extension CategoryVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        /// 도매자(상품등록)
        if let VCdelegate = WhGoodsUploadVCdelegate, let TCdelegate = WhGoodsUploadTCdelegate {
            ...
            if option_key != "여성의류" {
                ...
                if option_type == "category" {
                    ...
                    if TCdelegate.itemCategory_btn.titleLabel?.text ?? "" == "" {
            ...
            customAlert(message: "카테고리 변경으로 일부 옵션 설정값이 초기화 됩니다.", time: 1) {
                ...
                VCdelegate.WashingArray.removeAll()
